pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://http://98.87.89.230:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    post {
        success {
            echo "✅ Backend deployed: http://http://98.87.89.230:9090/springapp1"
            echo "✅ Frontend deployed: http://http://98.87.89.230:9090/frontapp1"
        }
        failure {
